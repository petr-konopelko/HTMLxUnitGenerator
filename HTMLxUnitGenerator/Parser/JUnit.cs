namespace HTMLxUnitGenerator.Parser
{
    ...
    internal class JUnit : IParser
    {
        public Report Parse(string filePath)
        {
            ...
            report.RunInfo.TestRunner = TestRunner.JUnit;
            ...
            if (singleSuite)
            {
                report.StartTime = docRoot.GetNullableAttribute("timestamp").ToDateTime();
            }
            else
            {
        ...
        private TestSuite CreateTestSuite(XElement testSuiteElement)
        {
            ...
            testSuite.StartTime = testSuiteElement.GetNullableAttribute("timestamp").ToDateTime();
